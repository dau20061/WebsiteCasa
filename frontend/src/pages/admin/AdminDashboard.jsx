      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
        ...
        {activeTab === 'machinery' && (
          <div className="bg-white rounded-3xl p-6 sm:p-8 border border-tea-border shadow-tea-sm space-y-6">
            ...
            {machinery.length === 0 ? (
              <div className="text-center py-16 px-4 bg-gray-50/70 rounded-3xl border border-dashed border-gray-200">
                <Cpu className="w-12 h-12 text-gray-300 mx-auto mb-3" />
                <h3 className="text-base font-bold text-gray-700">Chưa có thiết bị máy móc nào</h3>
                <p className="text-xs text-gray-500 mt-1 max-w-md mx-auto">
                  Dữ liệu mẫu đã được xóa hoàn toàn. Bấm nút "+ Thêm Thiết Bị Mới" ở góc trên để cập nhật thông tin thiết bị thực tế của nhà máy.
                </p>
                <button
                  onClick={() => handleOpenMachineryModal()}
                  className="mt-4 inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-amber-600 hover:bg-amber-700 text-white text-xs font-bold transition-all shadow-sm"
                >
                  <Plus className="w-4 h-4" />
                  <span>Thêm Thiết Bị Mới</span>
                </button>
